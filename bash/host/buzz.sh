...
if [ -d /Users/russ/Trango/nordic_sdk/nRF5x-Command-Line-Tools_latest/mergehex ]; then
      PATH=$PATH:/Users/russ/Trango/nordic_sdk/nRF5x-Command-Line-Tools_latest/mergehex
fi
if [ -d /Users/russ/Trango/nordic_sdk/nRF5x-Command-Line-Tools_latest/nrfjprog ]; then
      PATH=$PATH:/Users/russ/Trango/nordic_sdk/nRF5x-Command-Line-Tools_latest/nrfjprog
fi
